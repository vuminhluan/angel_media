			...
			<div class="navbar-header">
				<a href="db-default.html" class="navbar-brand">
					...
					<div class="brand-image brand-small">
						<img src="<?= base_url('public/backend/assets/img/logo-angel.png') ?>" alt="logo" class="logo-small">
					</div>
				</a>
				<!-- Toggle Button -->
					...
					<ul aria-labelledby="notifications" class="dropdown-menu notification">
						<li>
							<div class="notifications-header">
								...
								<img src="<?= base_url('public/backend/assets/img/notifications/01.jpg') ?>" alt="..." class="img-fluid">
							</div>
						</li>
						<li>
							<a href="#">
