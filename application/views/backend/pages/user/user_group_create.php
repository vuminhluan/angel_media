	...
	<div class="col-12">
		...
		<div class="widget has-shadow">
			...
			<div class="widget-body">
				<?php echo form_open(base_url('admin/user-groups/create'), ['class'=>'form-horizontal edit-user-form']); ?>

					<!-- --------------------- -->
					<div class="form-group row d-flex align-items-center mb-5">
						<label class="col-md-3 form-control-label d-flex justify-content-md-end">Tên nhóm</label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="group_name_create" value="" required>
							<small>
								<code>Bắt buộc.</code>
							</small>
						</div>
